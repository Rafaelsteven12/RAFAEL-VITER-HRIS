...
(25, 1, 'developer', 'r_is_developer', 'this is dev\n', '2026-05-04 08:05:56', '2026-05-04 08:05:58'),
(26, 1, 'admin', 'r_is_admin', 'this is admin', '2026-05-04 08:05:04', '2026-05-04 08:05:04'),
(27, 1, 'viewer', 'r_is_viewer', 'this is viewer', '2026-05-04 08:05:13', '2026-05-04 08:05:13');
...
(17, 1, 'Steven', 'Francis', 'steven05rafael12@gmail.com', '25', '$2y$10$62z4CKnWhTI/iHOZCmwOpupStfjsgI1AN.GdC.cisMxX50t15PTmW', '', '2026-05-04 15:05:22', '2026-05-04 15:24:48');
...
--
ALTER TABLE `settings_notification`
  MODIFY `notification_aid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `settings_roles`
--
ALTER TABLE `settings_roles`
  MODIFY `role_aid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `settings_users`
--
ALTER TABLE `settings_users`
  MODIFY `users_aid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
COMMIT;
